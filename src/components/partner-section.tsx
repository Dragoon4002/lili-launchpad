        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
          {partners.map((partner) => (
            <a
              ...
              className="bg-white/5 backdrop-blur-xs border border-white/10 rounded-lg p-6 flex flex-col items-center justify-center hover:scale-105 transition-transform"
            >
